...
n = 4
hcpuPerEvent1T = TH1F("hcpuPerEvent1T", "SME en diferente iteraciones de la dilatacion;Iteraciones;SME", n, 0, n)
...
if __name__ == "__main__":
    ...
    c1.SaveAs("exp2_comleto_IteracionesxError_cuadratico_dilatacion.png")
