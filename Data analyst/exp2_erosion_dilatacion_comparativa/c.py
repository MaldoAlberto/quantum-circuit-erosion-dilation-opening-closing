...
n = 4
hcpuPerEvent1T = TH1F("hcpuPerEvent1T", " Tiempo resultante en diferentes iteraciones para  el experimento 2 erosion-dilatacion;Iteraciones;Tiempo (segundos)", n, 0, n)
...
if __name__ == "__main__":
    ...
    legend.Draw()
    #c1.cd(5)
    c1.SaveAs("exp2_IteracionesxTiempo_erosion-dilatacion.png")
