...
n = 4
hcpuPerEvent1T = TH1F("hcpuPerEvent1T", "SSIM en diferente iteraciones de la dilatacion;Iteraciones;SSIM", n, 0, n)
...
#.. plot 2
    ...
    legend.Draw()
    #c1.cd(5)
    c1.SaveAs("exp1_comleto_IteracionesxSSIM_dilatacion.png")
