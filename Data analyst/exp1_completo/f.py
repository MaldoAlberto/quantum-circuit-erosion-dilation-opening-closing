...
n = 4
hcpuPerEvent1T = TH1F("hcpuPerEvent1T", "PSNR en diferente iteraciones de la erosion;Iteraciones;PSNR", n, 0, n)
...
#.. plot 2
    ...
    legend.Draw()
    #c1.cd(5)
    c1.SaveAs("exp1_comleto_IteracionesxPSNR_erosion.png")
