...
n = 1
hcpuPerEvent1T = TH1F("hcpuPerEvent1T", "PSNR en diferente iteraciones y tam de imagenes en apertura;Iteraciones;PSNR", n, 0, n)
...
if __name__ == "__main__":
    ...
    legend.Draw()
    #c1.cd(5)
    c1.SaveAs("IteracionesxPSNR_clausura.png")
