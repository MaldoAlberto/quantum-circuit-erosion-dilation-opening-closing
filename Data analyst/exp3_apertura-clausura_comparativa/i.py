...
n = 1
hcpuPerEvent1T = TH1F("hcpuPerEvent1T", "ssim en diferente iteraciones y tam de imagenes en clausura;Iteraciones;ssim", n, 0, n)
...
if __name__ == "__main__":
    ...
    legend.Draw()
    #c1.cd(5)
    c1.SaveAs("Iteracionesxssim_clausura.png")
