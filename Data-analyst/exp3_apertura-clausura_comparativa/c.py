...
n = 4
hcpuPerEvent1T = TH1F("hcpuPerEvent1T", "Tiempo resultante en diferentes iteraciones y tam de imagenes para apertura-clausura.;Iteraciones;Tiempo(segundos)", n, 0, n)
...
if __name__ == "__main__":
    ...
    legend.Draw()
    #c1.cd(5)
    c1.SaveAs("IteracionesxTiempo.png")
