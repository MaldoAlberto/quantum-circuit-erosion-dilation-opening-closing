...
n = 4
hcpuPerEvent1T = TH1F("hcpuPerEvent1T", "SME en diferente iteraciones y tam de imagenes en clausura;Iteraciones;SME", n, 0, n)
hcpuPerEvent4T = TH1F("hcpuPerEvent4T", "CPU time per event;config;CPU time (sec)", n, 0, n)
hcpuPerEvent1AT = TH1F("hcpuPerEven t1AT", "CPU time per event;config;CPU time (sec)", n, 0, n)
...
if __name__ == "__main__":
    ...
    legend.Draw()
    #c1.cd(5)
    c1.SaveAs("IteracionesxError_cuadratico_clausura.png")
