...
n = 4
hcpuPerEvent1T = TH1F("hcpuPerEvent1T", "Tiempo resultante en diferentes iteraciones para el experimento 1.;Iteraciones;Tiempo(segundos)", n, 0, n)
...
#.. plot 2
    ...
    legend.SetHeader("Imagen de entrada","C") # option "C" allows to center the header
    legend.AddEntry(hcpuPerEvent1T,"3x3","f")
    #legend.AddEntry(hcpuPerEvent4T,"128x128","f")
    #legend.AddEntry(hcpuPerEvent1AT,"256x256","f")
    #legend.AddEntry(hcpuPerEvent4AT,"4 thread and single track in 1","f")
    legend.Draw()
    #c1.cd(5)
    c1.SaveAs("exp1_IteracionesxTiempo.png")
