...
n = 4
hcpuPerEvent1T = TH1F("hcpuPerEvent1T", "PSNR en diferente iteraciones de la dilatacion;Iteraciones;PSRN", n, 0, n)
...
if __name__ == "__main__":
    ...
    #c1.cd(5)
    c1.SaveAs("exp2_IteracionesxPSNR_dilatacion.png")
